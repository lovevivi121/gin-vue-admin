<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="sno字段" prop="sno" width="120" />
        <el-table-column align="left" label="password字段" prop="password" width="320" />
        <el-table-column align="left" label="username字段" prop="username" width="120" />
        <el-table-column align="left" label="用户邮箱" prop="email" width="190" />
